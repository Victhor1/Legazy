...
@section('content')
    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="option-series">
            ...
            <div class="pt-16">
                {!!Form::open(['route'=>'serie.store','method'=>'POST','files'=>true, 'class'=>'w-full'])!!}
                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            {!!Form::date('date',null,['class'=>'appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-1 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500'])!!}
                        </div>
