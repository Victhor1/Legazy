...
@section('tags')
    ...
    <title>Genero - {{ $genre['name'] }}</title>
    <link rel="canonical" href="https://legazy.net/genre/{{ $genre['name'] }}" />
    <meta property="og:url" content="https://legazy.net/genre/{{ $genre['name'] }}" />
    <meta property="og:title" content="GENEROS" />
    <meta property="og:site_name" content="Generos" />
...
@section('content')
    ...
    <div class="container mx-auto px-4 pt-10">
        <div class="option-series">
            ...
            @if (count($series) > count($series) - 1)
